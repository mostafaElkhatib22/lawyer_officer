    ...
    <div>
      <div className="m-2">
        <input
          ...
          className="w-[150px] border-2 border-violet-400 md:w-[300px] lg:w-[400px] rounded-lg outline-none h-[40px] p-3"
      ...
      <Table className="text-center text-black">
        <TableCaption className="text-black">
          اجمالي عدد القضايا ({cases.length})
        </TableCaption>
        ...
        <TableBody>
          {cases.map((item, index) => (
            <TableRow key={index}>
              ...
              <TableCell>{formatDate(item.caseDate)}</TableCell>
              ...
              <TableCell className="flex justify-center items-center gap-4">
                ...
                <RemoveItem
                  ...
                  publicId={
                    item.files.length
                      ? `lawyer_office/${item.files[0].split("/").pop()?.split(".")[0]}`
                      : ""
                  }
                />
              </TableCell>
